...
const ItemCount = ({stock, onAdd}) => {
    ...
    return (
        <div>
            ...
            <div className="row">
                <div className="col-md-12 text-center">
                    {vendido ? <Link to={"/cart"} className="btn btn-outline-primary">Terminar mi compra</Link> : <button type="button" className="btn btn-outline-primary" onClick={() => { addToCart (counter)}}
